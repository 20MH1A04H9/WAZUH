...
# ── Step 2: Download MSI ──────────────────
Write-Host "`n[2/4] Downloading Wazuh Agent v$Version..." -ForegroundColor Yellow
...
if (-not (Test-Path $MsiPath)) {
    Write-Host "ERROR: Failed to download MSI. Exiting." -ForegroundColor Red
    exit 1
}
...
Write-Host "`n[4/4] Starting Wazuh Agent service..." -ForegroundColor Yellow
...
Write-Host "  ✅ Wazuh Agent deployed successfully!" -ForegroundColor Green
Write-Host "  Agent  : $AgentName"                   -ForegroundColor Green
Write-Host "  Server : $WazuhManager"                -ForegroundColor Green
Write-Host "  Log    : $LogPath"                     -ForegroundColor Green
Write-Host "  Check  : Agents → Summary → Active"   -ForegroundColor Green
Write-Host "=========================================" -ForegroundColor Green
Write-Host ""

# ── Show last 10 lines of agent log ───────
$agentLog = "$InstallPath\ossec.log"
if (Test-Path $agentLog) {
    Write-Host "--- Last 10 lines of ossec.log ---" -ForegroundColor Cyan
